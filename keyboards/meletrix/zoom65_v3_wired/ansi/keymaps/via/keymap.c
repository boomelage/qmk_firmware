...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [WIN_B] = LAYOUT_all( /* Base */
        ...
        KC_LCTL, KC_LGUI, KC_LALT,          KC_SPC,           KC_SPC,           KC_SPC,           KC_RALT, MO(WIN_FN), KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [WIN_FN] = LAYOUT_all( /* Fn */
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, KC_INS,  _______, KC_PSCR, _______, KC_DEL,  UG_NEXT, SC_UP,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, UG_TOGG, _______, _______,          UG_HUEU, SC_DOWN,
